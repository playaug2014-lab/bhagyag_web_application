                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text('${astrologer.chargesPerMinutes}/min', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black)),
                        ],
                      ),
                      InkWell(
                        onTap: () {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: astrologer.status.toLowerCase() == 'online' ? const Color(0xFF00C853) : const Color(0xFF797676),
                            borderRadius: BorderRadius.circular(20),
                          ),
                          child: Row(
                            children: [
                              Container(width: 35, height: 35, padding: const EdgeInsets.only(left: 9), child: const Icon(Icons.chat_bubble, size: 18, color: Colors.white)),
                              const SizedBox(width: 6),
                              const Text('Chat', style: TextStyle(fontSize: 13, color: Colors.white, fontWeight: FontWeight.w500)),
                            ],
                          ),
                        ),
                      ),
