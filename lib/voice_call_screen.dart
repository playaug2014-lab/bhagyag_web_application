                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          Text('${astrologer.voiceCallPerMinutes}/min', style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black)),
                        ],
                      ),
                      InkWell(
                        onTap: () {
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: astrologer.status.toLowerCase() == 'online' ? const Color(0xFF2196F3) : const Color(0xFF797676),
                            borderRadius: BorderRadius.circular(20),
                          ),
                          child: Row(
                            children: [
                              Container(width: 35, height: 35, padding: const EdgeInsets.only(left: 9), child: const Icon(Icons.phone, size: 18, color: Colors.white)),
                              const SizedBox(width: 6),
                              const Text('Call', style: TextStyle(fontSize: 13, color: Colors.white, fontWeight: FontWeight.w500)),
                            ],
                          ),
                        ),
                      ),
